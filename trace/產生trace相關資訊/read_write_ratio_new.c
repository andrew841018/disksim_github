...
int main(int argc, char *argv[]){
	if (argc != 5) {
    	fprintf(stderr, "usage: %s <Input trace file> <Output trace file> <unique page> <max page no>\n", argv[0]);
    	exit(1);
    }
    printf("Analyzing.......1");
